    ...
    <section class="module hero">
        <div class="container">
            <div class="content-wrapper text-box">
                ...
                <p>Lorem ipsum dolor sit amet, consetetur sadipscing dolorem sitear elitr, sed diam nonumy! Lorem ipsum
            ...
            <div class="image-wrapper">
                <img loading="lazy" width="500" height="537"
                    src="<?php echo get_template_directory_uri() ?>/asset/img/default-Profil.png"
                    class="attachment-medium size-medium" alt="" decoding="async" sizes="(width: 500px) 100vw, 500px">
            </div>
        </div>
    </section>
    ...
    <section class="module image-text image-first bg-none">
        <div class="container">
            <div class="text-wrapper text-box">
                ...
                <p>Lorem ipsum dolor sit amet, consetetur sadipscing dolorem sitear elitr, sed diam nonumy! Lorem ipsum
                    dolor sit amet, consetetur sadipscing elitr. Lorem ipsum dolor sit amet, consetetur sadipscing
                    dolorem sitear elitr, sed diam nonumy!</p>
                <p>Lorem ipsum dolor sit amet, consetetur sadipscing dolorem sitear elitr, sed diam nonumy! Lorem ipsum
                    dolor sit amet, consetetur sadipscing elitr.</p>
                <a href="/sample-page/" class="btn btn--empty" target="_blank" rel="noopener noreferrer">Sample Page</a>
            </div>
    ...
    <section class="module features bg-black">
        <div class="container">
            ...
            <div class="module__content">
                <div class="feature">
                    <div class="feature__icon">
                        <img loading="lazy" width="45" height="45"
                            src="<?php echo get_template_directory_uri() ?>/asset/icons/wp.svg"
                            class="attachment-icon-45 size-icon-45" alt="" decoding="async">
                    </div>
                ...
                <div class="feature">
                    <div class="feature__icon">
                        <img loading="lazy" width="56" height="63"
                            src="<?php echo get_template_directory_uri() ?>/asset/icons/square.svg"
                            class="attachment-icon-45 size-icon-45" alt="" decoding="async">
                    </div>
                    <div class="feature__content text-box">
                        <h4 class="heading">WordPress &amp; WooCommerce Entwicklung</h4>
                ...
                <div class="feature">
                    <div class="feature__icon">
                        <img loading="lazy" width="45" height="45"
                            src="<?php echo get_template_directory_uri() ?>/asset/icons/leaflet.svg"
                            class="attachment-icon-45 size-icon-45" alt="" decoding="async">
                    </div>
                    <div class="feature__content text-box">
                        <h4 class="heading">WordPress &amp; WooCommerce Entwicklung</h4>
        ...
        <div class="container column-3">
            <div class="column-3-1 text-box">
                ...
                <div class="module__textbox">
                    <p>Lorem ipsum dolor sit amet, consetetur sadipscing dolorem sitear elitr, sed diam nonumy! Lorem
                        ipsum dolor sit amet, consetetur<br>
                        sadipscing elitr. Lorem ipsum dolor sit amet, consetetur sadipscing dolorem sitear elitr, sed
                        diam nonumy! Lorem ipsum<br>
                        dolor sit amet, consetetur sadipscing elitr.</p>
                    <p>Lorem ipsum dolor sit amet, consetetur sadipscing dolorem sitear elitr, sed diam nonumy! Lorem
                        ipsum dolor sit amet, consetetur<br>
                        sadipscing elitr.</p>
            ...
            <div class="column-3-2">
                <div class="feature">
                    <div class="feature__icon">
                        <img loading="lazy" width="50" height="50"
                            src="<?php echo get_template_directory_uri() ?>/asset/img/nutzung-1.svg"
                            class="attachment-icon-45 size-icon-45" alt="" decoding="async">
                    </div>
                ...
                <div class="feature">
                    <div class="feature__icon">
                        <img loading="lazy" width="50" height="44"
                            src="<?php echo get_template_directory_uri() ?>/asset/img/nutzung-2.svg"
                            class="attachment-icon-45 size-icon-45" alt="" decoding="async">
                    </div>
                    <div class="feature__content">
                        <h4 class="heading">WordPress &amp; WooCommerce Entwicklung</h4>
                ...
                <div class="feature">
                    <div class="feature__icon">
                        <img loading="lazy" width="39" height="51"
                            src="<?php echo get_template_directory_uri() ?>/asset/img/nutzung-3.svg"
                            class="attachment-icon-45 size-icon-45" alt="" decoding="async">
                    </div>
                    <div class="feature__content">
                        <h4 class="heading">WordPress &amp; WooCommerce entwicklung</h4>
                ...
                <div class="feature">
                    <div class="feature__icon">
                        <img loading="lazy" width="50" height="41"
                            src="<?php echo get_template_directory_uri() ?>/asset/img/nutzung-4.svg"
                            class="attachment-icon-45 size-icon-45" alt="" decoding="async">
                    </div>
                    <div class="feature__content">
                        <h4 class="heading">WordPress &amp; WooCommerce Entwicklung</h4>
        ...
        <div class="container">
            ...
            <div class="swiper swiperCarousel swiper-initialized swiper-horizontal swiper-backface-hidden">
                <div class="swiper-wrapper"
                    style="transition-duration: 0ms; transform: translate3d(-715.5px, 0px, 0px); transition-delay: 0ms;"
                    id="swiper-wrapper-feccc97e210e979bf" aria-live="polite">
                    <div class="swiper-slide" style="margin-right: 24px;" role="group" aria-label="1 / 6"
                        data-swiper-slide-index="0">
                        <div class="slide">
                            <div class="slide__title">1. page-effect.com</div>
                            <div class="slide__text">web hosting</div>
                            <div class="slide__image">
                                <img loading="lazy" width="768" height="512"
                                    src="http://localhost:10004/wp-content/uploads/2023/08/hero-resp-768x512.jpg"
                                    sizes="(max-width: 768px) 100vw, 768px">
                            </div>
                        </div>
                    </div>
                    <div class="swiper-slide swiper-slide-prev" style="margin-right: 24px;" role="group"
                        aria-label="2 / 6" data-swiper-slide-index="1">
                        <div class="slide">
                            <div class="slide__title">2. page-effect.com</div>
                            <div class="slide__text">web hosting</div>
                            <div class="slide__image">
                                <img loading="lazy" width="768" height="430"
                                    src="http://localhost:10004/wp-content/uploads/2023/08/project-1-768x430.png"
                                    class="attachment-medium_large size-medium_large" alt="" decoding="async"
                                    srcset="http://localhost:10004/wp-content/uploads/2023/08/project-1-768x430.png 768w, http://localhost:10004/wp-content/uploads/2023/08/project-1-500x280.png 500w, http://localhost:10004/wp-content/uploads/2023/08/project-1-1204x674.png 1204w, http://localhost:10004/wp-content/uploads/2023/08/project-1-1536x860.png 1536w, http://localhost:10004/wp-content/uploads/2023/08/project-1-45x25.png 45w, http://localhost:10004/wp-content/uploads/2023/08/project-1-71x40.png 71w, http://localhost:10004/wp-content/uploads/2023/08/project-1.png 1896w"
                                    sizes="(max-width: 768px) 100vw, 768px">
                            </div>
                        </div>
                    </div>
                    <div class="swiper-slide swiper-slide-active" style="margin-right: 24px;" role="group"
                        aria-label="3 / 6" data-swiper-slide-index="2">
                        <div class="slide">
                            <div class="slide__title">3. page-effect.com</div>
                            <div class="slide__text">web hosting</div>
                            <div class="slide__image">
                                <img loading="lazy" width="768" height="432"
                                    src="http://localhost:10004/wp-content/uploads/2023/08/dummy_1600x900_ffffff_cccccc-768x432.png"
                                    class="attachment-medium_large size-medium_large" alt="" decoding="async"
                    ...
                    <div class="swiper-slide swiper-slide-next" style="margin-right: 24px;" role="group"
                        aria-label="4 / 6" data-swiper-slide-index="3">
                        <div class="slide">
                            <div class="slide__title">4. page-effect.com</div>
                            <div class="slide__text">web hosting</div>
                            <div class="slide__image">
                                <img loading="lazy" width="650"
                                    src="http://localhost:10004/wp-content/themes/PE-wp-theme/asset/img/dummy_650x365_ffffff_cccccc_16x9.png"
                                    class="dummy-image-16x9" alt="dummy image 16x9" decoding="async" srcset="">
                            </div>
                        </div>
                    </div>
                    <div class="swiper-slide" style="margin-right: 24px;" role="group" aria-label="5 / 6"
                    ...
                    <div class="swiper-slide" style="margin-right: 24px;" role="group" aria-label="6 / 6"
                ...
                <div class="swiper-button-next" tabindex="0" role="button" aria-label="Next slide"
                    aria-controls="swiper-wrapper-feccc97e210e979bf"></div>
    ...
    <section class="module blocks">
        <div class="container">
            ...
            <div class="module__content">
                ...
                <ul class="elements">
                    <li>
                        <img loading="lazy" width="142" height="40"
                            src="http://localhost:10004/wp-content/uploads/2023/08/partner-4-142x40.png"
                            class="attachment-logo-220 size-logo-220" alt="" decoding="async"
                            srcset="http://localhost:10004/wp-content/uploads/2023/08/partner-4-142x40.png 142w, http://localhost:10004/wp-content/uploads/2023/08/partner-4-45x13.png 45w, http://localhost:10004/wp-content/uploads/2023/08/partner-4.png 419w"
                            sizes="(max-width: 142px) 100vw, 142px">
                    </li>
                    <li>
                        <img loading="lazy" width="220" height="40"
                            src="http://localhost:10004/wp-content/uploads/2023/08/partner-3-220x40.png"
                            class="attachment-logo-220 size-logo-220" alt="" decoding="async"
                            srcset="http://localhost:10004/wp-content/uploads/2023/08/partner-3-220x40.png 220w, http://localhost:10004/wp-content/uploads/2023/08/partner-3-500x91.png 500w, http://localhost:10004/wp-content/uploads/2023/08/partner-3-1204x218.png 1204w, http://localhost:10004/wp-content/uploads/2023/08/partner-3-768x139.png 768w, http://localhost:10004/wp-content/uploads/2023/08/partner-3-45x8.png 45w, http://localhost:10004/wp-content/uploads/2023/08/partner-3.png 1478w"
                            sizes="(max-width: 220px) 100vw, 220px">
                    </li>
                    <li>
                        <img loading="lazy" width="180" height="40"
                            src="http://localhost:10004/wp-content/uploads/2023/08/partner-2-180x40.png"
                            class="attachment-logo-220 size-logo-220" alt="" decoding="async"
                            srcset="http://localhost:10004/wp-content/uploads/2023/08/partner-2-180x40.png 180w, http://localhost:10004/wp-content/uploads/2023/08/partner-2-500x111.png 500w, http://localhost:10004/wp-content/uploads/2023/08/partner-2-1204x267.png 1204w, http://localhost:10004/wp-content/uploads/2023/08/partner-2-768x170.png 768w, http://localhost:10004/wp-content/uploads/2023/08/partner-2-1536x341.png 1536w, http://localhost:10004/wp-content/uploads/2023/08/partner-2-45x10.png 45w, http://localhost:10004/wp-content/uploads/2023/08/partner-2.png 1917w"
                            sizes="(max-width: 180px) 100vw, 180px">
                    </li>
                    <li>
                        <img loading="lazy" width="98" height="40"
                            src="http://localhost:10004/wp-content/uploads/2023/08/partner-1-98x40.png"
                            class="attachment-logo-220 size-logo-220" alt="" decoding="async"
                            srcset="http://localhost:10004/wp-content/uploads/2023/08/partner-1-98x40.png 98w, http://localhost:10004/wp-content/uploads/2023/08/partner-1-45x18.png 45w, http://localhost:10004/wp-content/uploads/2023/08/partner-1.png 440w"
                            sizes="(max-width: 98px) 100vw, 98px">
                    </li>
                    <li>
                        <img loading="lazy" width="172" height="40"
                            src="http://localhost:10004/wp-content/uploads/2023/08/partner-5-172x40.png"
                            class="attachment-logo-220 size-logo-220" alt="" decoding="async"
                            srcset="http://localhost:10004/wp-content/uploads/2023/08/partner-5-172x40.png 172w, http://localhost:10004/wp-content/uploads/2023/08/partner-5-45x10.png 45w, http://localhost:10004/wp-content/uploads/2023/08/partner-5.png 387w"
